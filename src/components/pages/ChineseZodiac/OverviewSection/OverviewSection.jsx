				...
				<Grid container justifyContent="space-between">
					<Grid item xs={12}>
						<Body1>
							...
							tiger, rabbit, dragon, snake, horse, goat, monkey, rooster, dog
							and pig, each one has unique attributes. As a Chinese individual
							living in a Western country, I've always wanted to showcase the
							Chinese zodiac in a fun and modern way to a broader audience. The
							aim of the "Chinese Zodiac Collection" project is to celebrate and
							promote Chinese cultural heritage through the fusion of
							traditional art and modern design by reimagining the Chinese
							zodiacs through the traditional art of papercutting. Through this
							project, I would like to connect people across cultures with the
				...
				<Grid container justifyContent="space-between">
					<Box sx={{ display: "block" }}>
						...
						<Body1 sx={{ marginTop: "1rem" }}>
							...
							through traditional paper cut shapes, aiming to incorporate the
							Ruyi pattern and wheel for a unique representation of all 12
							animals. Complementary elements associated with the Chinese New
							Year, such as auspicious clouds, gold coins, and plum blossoms
							were selected to enrich the designs and highlight the cultural
							significance of the zodiac. In the color selection process, I
							wanted a modern twist on the traditional Chinese red, choosing a
			...
			<ProjectStepSection title="Graphic Design" id="3">
				<Grid container justifyContent="space-between">
					<Body1>
						...
						character and cultural significance of each animal. The

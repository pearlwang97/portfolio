			...
			<ProjectStepSection title="Overview" id="1">
				...
				<Grid container justifyContent="space-between">
					<Body1>
						...
						lifelike 2D vector designs that mimic the complexity and depth of 3D
				...
				<Grid container justifyContent="space-between">
					<Box sx={{ display: "block" }}>
						...
						<Body1>
							...
							simple solid color for the background and added a reflection under
							the radio. This reflection used a gradient effect to mimic how a
							shiny surface would reflect the radio. I also used the grain

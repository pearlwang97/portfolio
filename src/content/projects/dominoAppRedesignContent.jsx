...
export const dominoAppRedesignOverviewItems = [
...
export const getDominoAppRedesignNavGroups = ({ OverviewList }) => {
	return [
		{
			id: "1",
			label: "overview",
				...
				<ProjectStepSection title="Overview" id="1">
					...
					<Grid container justifyContent="space-between">
						<Grid item xs={12}>
							...
							<H4 sx={sectionHeadingSx}>Problem</H4>
							<Body1>
							...
							<H4 sx={sectionHeadingSx}>Solutions</H4>
							<List>
								<ListItem sx={listItemSx}>
			...
			render: () => (
				<>
					<ProjectStepSection title="Discover" id="2">
						<Grid item xs={12}>
							<H4 sx={sectionHeadingSx}>Evaluation</H4>
							<Body1>
							...
							<H4 sx={sectionHeadingSx}>User Research</H4>
							<Body1>
							...
							<H4 sx={sectionHeadingSx}>User Interview</H4>
							<Body1>
					...
					<ProjectStepSection title="Define" id="3">
						...
						<H4 sx={sectionHeadingSx}>Problem Statement</H4>
						<Body1>
						...
						<H4 sx={sectionHeadingSx}>How might we ...?</H4>
						<List>
							<ListItem sx={listItemSx}>
								<ListItemIcon>
									<FiberManualRecordIcon fontSize="10" />
					...
					<ProjectStepSection title="Design" id="4">
						<Grid container justifyContent="space-between">
							...
							/>
							<H4 sx={sectionHeadingSx}>Usability Test</H4>
							<Body1>
		...
		},
		{
			...
			render: () => (
				<ProjectStepSection title="Delivery" id="5">
					...
					<H4 sx={sectionHeadingSx}>Reflection</H4>
					<Body1>
					...
					<H4 sx={sectionHeadingSx}>If I have more time..</H4>
					<Body1>
